...
public class Sascha extends HolsDerGeierSpieler {
    ...
    private ArrayList<Integer> nochZuGewinnen = new ArrayList<>();
    ...
    private ArrayList<Integer> niedrigsteKarten = new ArrayList<>();
    private ArrayList<Integer> hoechsteKarten = new ArrayList<>();


    private ArrayList<Integer> letzteKarte = new ArrayList<>();
    private ArrayList<Integer> bereitsGespielt = new ArrayList<>();
