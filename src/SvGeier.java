//missing case: after a tie, n is n>10 or n<-5
import java.util.ArrayList;

/**
 * von Janis Albersmeier und Jakob G�mpel
 * Taktik SvGeier!
 *
 */
public class SvGeier extends HolsDerGeierSpieler {
    ...
    /**
     * Gebt den einzelnen Karten einen Rang und w�hlt nach gegebener Taktik eine aus!
     *
     * @param naechsteKarte - Die Geier/M�usekarte welche "in der Mitte" liegt und um die gespielt wird
     * @return wahl - Die gespielte Geierkarte
     */
    public int gibKarte(int naechsteKarte) {
        if(myCards.size()!=15){
            enemyCards.add(letzterZug() == 1 ? 0 : 1);
        }else{
            enemyCards.add(0);
        }
    ...
    /**
     * @deprecated
     * Wird von unserer Taktik nach langem �berlegen nicht verwendet und wurde deshalb nicht mehr gepr�ft!
    ...
    /**
     * Hier wird die Karte ausgew�hlt! Die eigentliche Taktik wird angewandt...
     *
     * @param a - 1. Wahl
     * @param b - 2. Wahl
     * @param c - 3. Wahl
